...
Make sure these files exist:
    ...
    models/scaler.pkl
    results/web_evaluation.csv     (produced by nasa_anomaly_detection.py)
    results/flagged_anomalies.csv  (produced by nasa_anomaly_detection.py)
"""
...
MODEL_FILE = ROOT / "models" / "anomaly_model.pkl"
SCALER_FILE = ROOT / "models" / "scaler.pkl"
RESULTS_CSV = ROOT / "results" / "web_evaluation.csv"
...
def level2_distribution(results_csv=RESULTS_CSV):
    print("\n" + "=" * 58)
    ...
    try:
        ...
        print("  [!] results/web_evaluation.csv not found — skipping")
        return
...
def level3_pseudo_accuracy(results_csv=RESULTS_CSV):
    print("\n" + "=" * 58)
